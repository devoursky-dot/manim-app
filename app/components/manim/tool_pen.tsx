...
export function ToolPen({ penOptions, setPenOptions, onUndo, onClear }: ToolPenProps) {
  // 사용 가능한 색상 팔레트
  const colors = ["#FFFFFF", "#FF3B30", "#34C759", "#007AFF", "#FFCC00"];

  return (
    <div className="flex flex-col gap-3 bg-gray-800/90 backdrop-blur p-4 rounded-lg shadow-lg text-white z-10 border border-gray-700 w-48">
      {/* 모드 전환 버튼 */}
